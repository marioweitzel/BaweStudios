...
argument-hint: Escribe "comenzar <workspace_user_id>", "continuar <workspace_user_id> <project_name>" o "eliminar <workspace_user_id> <project_name>"
...
El workspace raíz contiene el motor BaWe y los workspaces de usuario:
